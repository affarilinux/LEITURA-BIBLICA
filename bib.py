...
def ATIVAR_LEITURA_1_db():
	...
	bt_entrada_1 = Button(top_ativar_leitura_BD_1,                            ###botao
							text = 		 "SALVAR",
							font =       'Arial 10 bold',           
	...
	BT_reiniciar = Button(top_ativar_leitura_BD_1,                           ###botao
							text = 		 "REINICIAR",
							font =       'Arial 10 bold',            
							foreground = verde_limao)
	BT_reiniciar.place(x = 250, y = 120, width = 90 )

	BT_apagar = Button(top_ativar_leitura_BD_1,                              ###botao
							text = 		 "APAGAR",
							font =       'Arial 10 bold',            
							foreground = verde_limao)
	BT_apagar.place(x = 50, y = 120, width = 90 )
	top_ativar_leitura_BD_1.mainloop()
...
def FORMULARIO_ATIVAR_LEITURA():
	...
	label_button_1= Label(top_ativar_leitura,                                ###label                                  
				text =       "QUANTIDADE  DE DIAS: ",
				background = alice_blue,                         
				font =       'Arial 10 bold',
				width =       25)
	...
	botao_leitura_1_db = Button(top_ativar_leitura,                        ###botao
